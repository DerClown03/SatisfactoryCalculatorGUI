...
namespace SatisfactoryCalculatorGUI.MVVM.Model
{
    ...
    public class MachineModel
    {
        ...
        public MachineModel(string machine)
        {
            ...
            MACHINESDICT.Add("particle_accelerator", new string[,] { { "quickwire", "500" }, { "supercomputer", "10" }, { "cooling_system", "50" }, { "fused_modular_frame", "25" }, { "turbo_motor", "10" } }); // , { "concrete", "100" }
            MACHINESDICT.Add("quantum_encoder", new string[,] { { "turbo_motor", "20" }, { "supercomputer", "20" }, { "cooling_system", "50" }, { "time_crystal", "50" }, { "ficsite_trigon", "100" } });
            MACHINESDICT.Add("converter", new string[,] { { "fused_modular_frame", "10" }, { "cooling_system", "25" }, { "radio_control_unit", "50" }, { "sam_fluctuator", "50" } });
