...
namespace SatisfactoryCalculatorGUI.MVVM.Model
{
    public class SatisfactoryCalculator : ObservableObject
    {
        ...
        public static string[] DEFAULTRESOURCES = new string[] { "limestone", "iron_ore", "copper_ore", "caterium_ore", "coal", "raw_quartz", "sulfur", "bauxite", "uranium", "water", "crude_oil", "nitrogen_gas", "uranium_waste" };
        public static string[] MACHINES = new string[] { "smelter", "foundry", "constructor", "assambler", "manufacturer", "refinery", "blender", "particle_accelerator", "packager" };
